...
class UserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($validated['role'] === 'institution_representative' && empty($validated['institution_id'])) {
            return back()->withErrors(['institution_id' => 'Institution representatives must be linked to an institution.'])->withInput();
        }
        ...
        return redirect()->route('fiu.users.index')->with('success', 'User account created successfully.');
    }
