...
<section class="overflow-hidden rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-700 via-indigo-700 to-slate-900 p-6 shadow-md">
    ...
    <a href="{{ route('fiu.outcomes.assignments.index') }}" class="inline-flex items-center justify-center gap-2 rounded-xl border border-indigo-100 bg-indigo-50 px-3.5 py-2 text-xs font-black text-indigo-700 transition duration-200 hover:-translate-y-0.5 hover:bg-indigo-100/80">
...
<section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4" aria-label="FIU dashboard metrics">
                    ...
                    <div x-data="{ outcomesOpen: true }" class="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm">
                        <div class="flex flex-col gap-3 border-b border-slate-200 pb-4 sm:flex-row sm:items-start sm:justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                <a href="{{ route('fiu.outcomes.assignments.index') }}" class="inline-flex items-center rounded-2xl px-3 py-2 text-sm font-black text-blue-700 transition hover:bg-blue-50 hover:text-blue-900">Manage assignments</a>
                                <button
                                    type="button"
 ...
 <div class="rounded-[2rem] border border-sky-400 bg-sky-900 p-6 shadow-md">
    ...
    <div class="mt-4 grid gap-3">
        ...
        {{-- Button 2: Assign Immediate Outcome --}}
        <a href="{{ route('fiu.outcomes.assignments.create') }}" class="group inline-flex items-center justify-center gap-2 rounded-2xl border border-sky-700 bg-sky-950/40 px-4 py-3 text-center text-sm font-black text-white shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-sky-300 hover:bg-sky-800/50">
