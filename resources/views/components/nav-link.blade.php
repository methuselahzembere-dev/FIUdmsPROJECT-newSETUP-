...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-blue-600 text-sm font-black leading-5 text-slate-900 focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out'
